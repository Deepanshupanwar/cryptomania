...
export default function Profile() {
    ...
    const getProfile = async () => {
        const response = await fetch('https://cryptomania-deepanshus-projects-b59175f2.vercel.app/api/profile/' + id, {
            method: 'GET'
        })
    ...
    const removeFriend = async (id) => {
        if (userInfo !== null) {
            fetch('https://cryptomania-deepanshus-projects-b59175f2.vercel.app/api/removefriend', {
                method: 'DELETE',
                credentials: "include",
    ...
    const editProfile = async (data) => {
        ...
        if (userInfo !== null) {
            fetch('https://cryptomania-deepanshus-projects-b59175f2.vercel.app/api/profileEdit', {
                method: 'PUT',
                credentials: 'include',
                body: newdata
            })
    ...
    const getposts = async () => {
        fetch('https://cryptomania-deepanshus-projects-b59175f2.vercel.app/api/getPost/' + id, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(post => {
